---
name: Bug report
about: Create a report to help improve the CommandTab UI
title: ''
labels: bug
assignees: APEbbers
...
- CommandTab information (Develop version only):
  Go to "Help->About ...->About CommandTab UI". Click on "Copy to clipboard" and past here.
