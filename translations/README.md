# About translating CommandTab Addon
...
at <https://crowdin.com/project/freecad-addons> webpage and find the **CommandTab** project.

## Creating file for missing locale

### Using script

To create a file for a new language with all **CommandTab** translatable strings execute
...
Also you can rename new `FreeCAD_CommandTab.ts` file by appending the locale code,
for example, `FreeCAD_CommandTab_de.ts` for German and change
...
once done, look for the **CommandTab** project.
...
Now you can contribute your translated `.ts` file to **CommandTab** repository,
also include the `.qm` file.

<https://github.com/APEbbers/FreeCAD-CommandTab>
